...
public enum PrintingError: Error, LocalizedError, Sendable {
  ...
  public var errorDescription: String? {
    ...
    case .printOperationFailed(let success, let error):
      if let error = error { return "Print operation failed: \(error.localizedDescription)" }
    ...
    case .cancelled(let message):
      if let message = message { return "Operation cancelled: \(message)" }
      return "Operation cancelled"

    case .noResultProduced: return "No result was produced from rendering operation"
  ...
  public var failureReason: String? {
    switch self {
    case .invalidHTML: return "The HTML content may be malformed or contain unsupported elements"
    ...
    case .webViewAcquisitionTimeout: return "All WebViews are busy processing other documents"

    case .webViewPoolInitializationFailed:
      return "System resources may be insufficient to create WebViews"

    case .pdfGenerationFailed: return "The rendering engine encountered an error creating the PDF"

    case .printOperationFailed: return "The system print operation could not complete"

    case .documentTimeout: return "Document is too large or complex to process within the timeout"

    case .batchTimeout: return "Batch contains too many documents to process within the timeout"

    case .cancelled: return "User or system cancelled the operation"

    case .noResultProduced: return "The rendering operation completed but produced no output"
  ...
  public var recoverySuggestion: String? {
    ...
    case .invalidFilePath: return "Verify the file path exists and has write permissions"
    ...
    case .webViewPoolExhausted: return "Reduce maxConcurrentOperations in PrintingConfiguration"

    case .webViewAcquisitionTimeout:
      return "Increase webViewAcquisitionTimeout or reduce concurrent operations"

    case .webViewPoolInitializationFailed: return "Restart the application or reduce the pool size"

    case .pdfGenerationFailed: return "Check the HTML content for rendering issues"

    case .printOperationFailed: return "Check system print settings and available disk space"
    ...
    case .cancelled: return "Retry the operation if needed"

    case .noResultProduced: return "Check that the document was properly configured and retry"
...
extension PrintingError {
  ...
  /// }
  /// ```
  public var errorCode: String { metricsReason }
  ...
  public var underlyingError: Error? {
    switch self {
    case .invalidFilePath(_, let error), .webViewPoolInitializationFailed(let error),
      .printOperationFailed(_, let error):
      return error
    case .directoryCreationFailed(_, let error), .webViewLoadingFailed(let error),
      .webViewNavigationFailed(let error), .pdfGenerationFailed(let error):
      return error
    default: return nil
    }
  }
...
extension PrintingError {
  ...
  var metricsReason: String {
    switch self {
    // Document Errors
    case .invalidHTML: return "invalid_html"
    case .invalidFilePath: return "invalid_file_path"
    case .directoryCreationFailed: return "directory_creation_failed"

    // WebView Errors
    case .webViewLoadingFailed: return "webview_loading_failed"
    case .webViewNavigationFailed: return "webview_navigation_failed"
    case .webViewRenderingTimeout: return "webview_rendering_timeout"

    // Pool Errors
    case .webViewPoolExhausted: return "webview_pool_exhausted"
    case .webViewAcquisitionTimeout: return "webview_acquisition_timeout"
    case .webViewPoolInitializationFailed: return "webview_pool_initialization_failed"

    // PDF Generation Errors
    case .pdfGenerationFailed: return "pdf_generation_failed"
    case .printOperationFailed: return "print_operation_failed"
    case .documentTimeout: return "document_timeout"
    case .batchTimeout: return "batch_timeout"

    // Cancellation
    case .cancelled: return "cancelled"
    case .noResultProduced: return "no_result_produced"
