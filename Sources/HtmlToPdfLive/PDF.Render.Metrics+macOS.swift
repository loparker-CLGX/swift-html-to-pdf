        ...
        public static var liveValue: Self {
            return Self(
                ...
                recordRenderDuration: { duration, mode in
                    let nanoseconds =
                        duration.components.seconds * 1_000_000_000 + duration.components
                    ...
                    if let mode = mode {
                        ...
                        Timer(label: "htmltopdf_render_duration_seconds").recordNanoseconds(
                            nanoseconds
                        )
                    }
                },
                ...
                recordPoolAcquisitionTime: { duration in
                    let nanoseconds =
                        duration.components.seconds * 1_000_000_000 + duration.components
                        .attoseconds / 1_000_000_000
                    Timer(label: "htmltopdf_pool_acquisition_seconds").recordNanoseconds(
                        nanoseconds
                    )
                },
