...
@Suite("PDF Appearance Tests") struct AppearanceTests {

    @Test("Light appearance is the default") func lightIsDefault() async throws {
        let config = PDF.Configuration()
        #expect(config.appearance == .light)
    }

    @Test("Light appearance generates white background CSS") func lightAppearanceCSS() async throws
    {
    ...
    @Test("Dark appearance generates dark background CSS") func darkAppearanceCSS() async throws {
    ...
    @Test("Auto appearance generates no CSS") func autoAppearanceNoCSS() async throws {
    ...
    @Test("PDF renders with light appearance by default") func renderWithDefaultLight() async throws
    {
    ...
    @Test("PDF renders with dark appearance when configured") func renderWithDarkAppearance()
        async throws
    {
        @Dependency(\.pdf) var pdf
    ...
    @Test("PDF renders with auto appearance when configured") func renderWithAutoAppearance()
        async throws
    {
        @Dependency(\.pdf) var pdf
