  ...
  @Dependency(\.pdf) var pdf
    ...
    func printFormatterCannotRenderImages() async throws {
      try await withTemporaryDirectory { tempDir in
        ...
        // Get file sizes
        let textOnlySize =
          try FileManager.default.attributesOfItem(atPath: textOnlyOutput.path)[.size] as! Int64
        let withImageSize =
          try FileManager.default.attributesOfItem(atPath: withImageOutput.path)[.size] as! Int64
